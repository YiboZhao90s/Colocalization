...
write.table(pres1, "ukb_pQTL_b38.txt", row.names = T, sep = "\t", quote = F)
write.table(pres2, "ukb_pQTL_b37.txt", row.names = T, sep = "\t", quote = F)
write.table(pres3, "decode_pQTL_b38.txt", row.names = T, sep = "\t", quote = F)
write.table(pres2, "decode_pQTL_b37.txt", row.names = T, sep = "\t", quote = F)
